...
程式如何安裝執行：在Github，有一個壓縮檔名叫:計畫.zip，下載這個壓縮檔後，解壓縮全部，打開Visual Studio 2022，點選開啟本機資料夾(F)，找到解壓縮好，名叫程式的資料夾點開，
點Book.h、Book.cpp、Library.h、Library.cpp、LibrarySystem.h後，在執行那邊按執行目前的文件，執行程式。
